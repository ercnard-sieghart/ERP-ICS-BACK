	...
	#else
		#define STR0901 "Sem preco e sem diferencial"
		#define STR0902 "Com diferencial e sem preco"
		#define STR0903 "Fixado"
		#define STR0904 "Com preco inicial"
		#define STR0905 "Proxima Pagina"
		#define STR0906 "PORTUGUES"
		#define STR0907 "INGLES"
		#define STR0908 "ESPANHOL"
	#endif
#endif
