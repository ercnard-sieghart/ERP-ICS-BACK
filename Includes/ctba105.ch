	...
	Static  STR0008 :=  "Total debito: "
	Static  STR0009 :=  "Total credito: "
	Static  STR0010 :=  "íDebito y credito diferentes! ¿Continua?"
	...
	#define STR0057 "Para finalizar esta opcion, es necesario confirmar o borrar la(s) linea(s) de registro(s) contable(s)!"
	#define STR0058 "Linea"
		...
		Static  STR0008 :=  "Total Debit: "
		Static  STR0009 :=  "Total Credit: "
		Static  STR0010 :=  "Debit and Credit do not match!! Continue?"
		...
		#define STR0057 "Para encerrar essa opção é necessário confirmar ou excluir a(s) linha(s) de lançamento(s) contábil!"
		...
		Static  STR0008 :=  "Total Debito: "
		Static  STR0009 :=  "Total Credito: "
		Static  STR0010 :=  "Debito e Credito nao Conferem!! Prossegue?"
...
#IFDEF SPANISH
	...
	uInit := Nil
		...
		If cPaisLoc == "MEX"
			...
			STR0008 := "Total cargo: "
			STR0009 := "Total Abono: "
			STR0010 := "iCargo y Abono no coinciden! ¿Continua?"
		EndIf
	Return Nil
#ENDIF
...
#IFDEF ENGLISH
	...
	uInit := Nil
		...
		If cPaisLoc == "MEX"
			STR0004 := "Doc"
			STR0008 := "Total Debit: "
			STR0009 := "Total Credit: "
			STR0010 := "Debit and Credit do not match!! Continue?"
		EndIf
	Return Nil
#ENDIF
...
#IFNDEF SPANISH
 #IFNDEF ENGLISH
	...
	uInit := Nil
		...
		If cPaisLoc == "MEX"
			STR0004 := "Doc"
			STR0008 := "Total Debito: "
			STR0009 := "Total Credito: "
			STR0010 := "Debito e Credito nao Conferem!! Prossegue?"
		EndIf
	Return Nil
 #ENDIF
#ENDIF
