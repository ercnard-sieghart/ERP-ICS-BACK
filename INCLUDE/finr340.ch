	...
	#define STR0059 "¡Opcion valida solo para entorno TOP!"
		...
		#define STR0019 If( cPaisLoc $ "ANG|PTG", "                                                                           Descontos  Abatimentos        Juros        Multa  Corr. Monet.    Valor Liquidado  Rec.Antecip.      Saldo Actual  Motivo           Situação   Port.", "                                                                           Descontos  Abatimentos        Juros        Multa  Corr. Monet    Valor Baixado  Rec.Antecip.      Saldo Atual  Motivo           Situacao   Port." )
